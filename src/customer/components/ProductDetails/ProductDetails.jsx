  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-3 lg:grid-cols-2 gap-x-8 gap-y-10  px-4 pt-10">
          {/* Image gallery */}
          ...
          >
            <div className="lg:col-span-2">
              {/* Brand name */}
              <h1 className="text-l lg:text-xl font-semibold text-gray-900">
                Universaloutfit
              </h1>
              {/* Product title */}
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">34598 Ratings</p>
        ...
        {/* Recent Review and Rating section. */}
        <section>
          <h1 className="font-semibold text-lg pb-4">Recent Review & Rating</h1>
          <div className="border p-5">
            <Grid container spacing={7}>
              {/* Product reivew and rating by customers */}
              <Grid size={{ xs: 7 }}>
              ...
              <Grid size={{ xs: 5 }}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">98898 Ratings</p>
                </div>

                <Box className="mt-5 space-y-3">
                  {/* Excellent rating grid */}
